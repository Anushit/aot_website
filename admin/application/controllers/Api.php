...
public function saveinquery_post(){ 
    ...
    public function service_post(){
        ...
        {    
            ...
            $service_data = $this->service_model->all_service($select,$search,$start,$limit);
            
            $count_data = $this->service_model->count_service();
    ...
    public function service_details_get($id=null){
        ...
        if ($this->input->server('REQUEST_METHOD') == 'GET') 
        {      
            $service_details_data = $this->service_model->get_service_by_slug($id);
    ...
    public function get_products_post(){
        ...
        {      
            ...
            $product_data = $this->product_model->allproducts($cat_id);
    ...
    public function product_details_get($id=null){
        ...
        {      
            ...
            $product__details_data = $this->product_model->getProductdetail($id);
