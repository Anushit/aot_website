...
if(isset($_POST['submit'])){ 
    ...
    if($error==''){
        $data = $_POST;  
        $contactData = postData('serviceinquery', $data);
    ...
    <section class="contact-section">
        <div class="auto-container">
            ...
            <div class="sec-title centered">
                <h1>Inquery For <?=$serviceInquery['name']?></h1>
                <div class="text"></div>
            </div>
            ...
            <div class="form-container">
                ...
                <div class="form-style-one quote-form">
                    <form method="post" action="<?=BASE_PATH.'service_inquery/'.$serviceInquery['slug'] ?>" id="contactFrom" name="contactFrom">
